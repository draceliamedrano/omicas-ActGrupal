# omicas-ActGrupal
Análisis de la expresión diferencial de genes relacionados con la obesidad mediante RNA-seq.

Trabajaremos con las siguientes muestras:
- Obeso: Abraham y Homer Simpson.
